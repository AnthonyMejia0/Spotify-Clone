...
function Player() {
    ...
    return (
        <div className="absolute bottom-[4.5rem] md:bottom-0 h-24 w-full bg-gray-900 md:bg-gradient-to-t md:from-black md:to-gray-900 text-white grid grid-cols-2 md:grid-cols-3 text-base px-2 md:px-8">
            {/* Left */}
