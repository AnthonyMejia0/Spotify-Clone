...
function Sidebar() {
  ...
  return (
    <div>
      <div className='text-gray-500 p-5 text-xs lg:text-sm border-r-gray-900 border-r h-[calc(100%-6rem)] overflow-y-scroll w-[12rem] lg:w-[15rem] hidden md:inline-flex'>
